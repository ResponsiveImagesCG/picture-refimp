(function(window, srcsetParser){
    ...
    function processImg(){
        ...
        if(this.hasAttribute("srcset") === false  && !this.complete){
            return;
        }
        ...
        function asyncPortion(){
            ...
            //If the img element's src, srcset, or crossorigin attributes have been set, changed, or removed since this algorithm started, then abort these steps.
            ...
            //Replace the img element's image data with the resource obtained by the earlier step of this algorithm. It can be either CORS-same-origin or CORS-cross-origin; this affects the origin of the image itself (e.g. when used on a canvas).
